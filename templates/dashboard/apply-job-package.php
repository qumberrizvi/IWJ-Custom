...
<div class="iwj-user-packages iwj-main-block">
	<div class="add-new-package">
		<a class="iwj-btn iwj-btn-primary" href="<?php echo add_query_arg(array('iwj_tab' => 'new-apply-job-package'), $dashboard) ; ?>"><?php echo __('New Apply Class Package', 'iwjob'); ?></a>
	</div>
	<div class="iwj-user-packages-table iwj-table-overflow-x">
		<table class="table">
			...
			<tr class="package-heading">
				...
				<th width="20%"><?php echo __('Apply Class Remaining', 'iwjob');?></th>
