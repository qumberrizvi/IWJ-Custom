    ...
    <div class="row">
        ...
        if ( $query->have_posts() ) :
            while ( $query->have_posts() ) :
                ...
                ?>
                <div class="grid-content" itemscope itemtype="http://schema.org/Organization">
                    <div class="iwj-employer-item">
                        <?php if ( $image ) : ?>
                            <div class="employer-image" itemprop="image"><?php echo $image; ?></div>
                        <?php endif; ?>
                        <div class="employer-info">
                            ...
                            <div class="info-company">
                                ...
                                <?php if ( $employer->get_locations_links() ) : ?>
                                    <div class="address">
                                        <i class="ion-android-pin"></i><?php echo $employer->get_locations_links(); ?></div>
                                <?php endif; ?>
