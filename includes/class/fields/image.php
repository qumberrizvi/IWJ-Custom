 ...
 */
class IWJMB_Image_Field extends IWJMB_File_Field {
	...
	public static function enqueue_scripts() {
		wp_register_style( 'iwjmb-image', IWJ_FIELD_ASSETS_URL . 'css/image.css', array() );
	}
	...
	public static function file_html( $image ) {
		...
		return sprintf(
			'<li id="item_%s">
				<img src="%s">
				<div class="iwjmb-image-bar">
					<a href="%s" target="_blank"><span class="dashicons dashicons-edit"></span></a> |
					<a class="iwjmb-delete-file" href="#" data-attachment_id="%s">&times;</a>
				</div>
			</li>',
			$image,
			$src,
    ...
    public static function input( $meta, $field ) {
        wp_enqueue_style( 'iwjmb-image');
        return parent::input( $meta, $field );
    }
}

IWJMB_Image_Field::init();