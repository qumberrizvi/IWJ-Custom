 ...
 */
abstract class IWJMB_Choice_Field extends IWJMB_Field {
	...
	public static function filter_options( $field, $options ) {
		...
		foreach ( $options as &$option ) {
			$option         = apply_filters( 'iwjmb_option', $option, $field );
			$option->$label = apply_filters( 'iwjmb_option_label', $option->$label, $option, $field );
		}
		return $options;
	}
