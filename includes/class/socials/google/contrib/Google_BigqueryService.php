 ...
 */
   ...
   *  </code>
   */
  class Google_ClassesServiceResource extends Google_ServiceResource {
    ...
    /**
     * Lists all the Classes in the specified project that were started by the user. (jobs.list)
     *
     ...
     */
    public function listClasses($projectId, $optParams = array()) {
      $params = array('projectId' => $projectId);
      $params = array_merge($params, $optParams);
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
     ...
     * @param string $jobId Class ID of the query job
     * @param array $optParams Optional parameters.
     *
     ...
     * @param string $jobId Class ID of the requested job
     * @param array $optParams Optional parameters.
     * @return Google_Job
     */
...
class Google_JobList extends Google_Model {
  ...
  public $kind;
  public $etag;
  protected $__jobsType = 'Google_JobListClasses';
  ...
  public function setClasses(/* array(Google_JobListClasses) */ $jobs) {
    $this->assertIsArray($jobs, 'Google_JobListClasses', __METHOD__);
    $this->jobs = $jobs;
  }
...
class Google_JobListClasses extends Google_Model {
  protected $__statusType = 'Google_JobStatus';
  protected $__statusDataType = '';
  public $status;
  public $kind;
