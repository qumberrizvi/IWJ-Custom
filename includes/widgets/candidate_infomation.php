...
class IWJ_Widget_Candidate_Infomation extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            'description' => esc_html__( 'Display Teacher Information, used only with sidebar employer details.', 'iwjob' ),
            'customize_selective_refresh' => true,
        );
        parent::__construct( 'iwj_candidate_infomation', esc_html__( '[IWJ] Teacher Information', 'iwjob' ), $widget_ops );
    }
    ...
    public function form( $instance ) {
        $instance = wp_parse_args( (array) $instance, array( 'title' => '', 'style' => 'style1') );
