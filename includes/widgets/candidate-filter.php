...
class IWJ_Widget_Candidate_Filter extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            'description' => esc_html__( 'Teachers Filter Widget.', 'iwjob'),
            'customize_selective_refresh' => true,
        );
        parent::__construct( 'iwj_candidate_filter', esc_html__( '[IWJ] Filter Teachers', 'iwjob' ), $widget_ops );
    }
    ...
    public function form( $instance ) {
        $instance = wp_parse_args( (array) $instance, array( 'title' => __('Teacher Filter', 'iwjob') ) );
