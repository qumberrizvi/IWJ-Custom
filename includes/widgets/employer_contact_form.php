...
class IWJ_Widget_Employer_Contact_Form extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            'description' => esc_html__( 'Display Student Contact Form.', 'iwjob' ),
            'customize_selective_refresh' => true,
        );
        parent::__construct( 'iwj_employer_contact_form', esc_html__( '[IWJ] Student Contact Form', 'iwjob' ), $widget_ops );
    }
